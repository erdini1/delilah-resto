...
router.post('/', middlesProducts.validate_started_session, middlesProducts.validate_admin, newPayment)

//El admin puede modificar un metodo de pago con el id pasado por parametro
router.put('/:idPayment', middlesProducts.validate_started_session, middlesProducts.validate_admin, middlesPayments.validate_id_payment, modifyPayment)
