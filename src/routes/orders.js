...
router.post('/', middlesProducts.validate_started_session, verify_disabled, middlesOrders.validate_data_orders,  middlesPayments.validate_payment_method, middlesOrders.addAddress, middlesOrders.validate_id_address,  newOrder)

//El usuario puede modificar su pedido solo mientras el estado sea "pendiente"
router.put('/:idOrder', middlesProducts.validate_started_session, verify_disabled, middlesOrders.validate_id_order, middlesOrders.modify_order, middlesOrders.validate_data_orders, middlesPayments.validate_payment_method, middlesOrders.addAddress, middlesOrders.validate_id_address, modifyOrder)
